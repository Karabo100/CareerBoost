...
# def get_completion(prompt, model="gpt-4.0-turbo"):
#     completion = openai.api_key.chat.completions.create(model=model,
#     messages=[
...
#     st.write("Welcome! This feature serves as your resume job recommendation guide using AI. PLEASE BE CAUTIOUS: Remember to exclude sensitive and personal information on the PDF file you upload.")
